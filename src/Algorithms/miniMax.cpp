...
std::pair<int, int> Algorithm::computeTree()
{
...
int Algorithm::miniMax(int depth, bool playerTurn, int alpha, int beta, int x, int y, std::vector<std::pair<int, int>> moves)
{
